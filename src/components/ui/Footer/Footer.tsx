...
const Footer = () => {
    return <footer className="Footer dark:bg-black-900">
        <div className="container mx-auto w-full lg:py-8">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0" style={{
                    maxWidth: "40%",
                }}>
                    <a href="https://flowbite.com/" className="flex items-center mb-4 ">
                        {/* <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 me-3" alt="FlowBite Logo" /> */}
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Thành phố tội lỗi</span>
                    </a>

                    <p className="text-white-900" style={{
                        maxWidth: "80%",
                    }}>Chúng tôi là một studio game độc lập, đam mê sáng tạo những trải nghiệm game độc đáo, giàu cảm xúc và đậm chất nghệ thuật. Chúng tôi không chỉ làm game chúng tôi tìm kiếm và tạo ra các giá trị thông qua các trò chơi. </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-3">
                                <a href="#" className="hover:underline">Cộng đồng</a>
                            </li>

                            <li className="mb-3">
                                <a href="#" className="hover:underline">Khám phá</a>
                            </li>
                            <li className="mb-3">
                                <a href="#" className="hover:underline">Về chúng tôi</a>
                            </li>
                            <li>
                                <a href="#our-values" className="hover:underline">giá trị và mục tiêu  </a>
                            </li>
                        </ul>
                    </div>
                  
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-white-900 uppercase dark:text-white">Legal</h2>
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">TPTL Team</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 sm:justify-center sm:mt-0">
                    {/* <a href="#" className="text-gray-500 hover:text-white-900 dark:hover:text-white">
                        <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                            <path d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" />
                        </svg>
                        <span className="sr-only">Facebook page</span>
                    </a> */}
                    <a href="#" className="text-gray-500 hover:text-white-900 dark:hover:text-white ms-5">
